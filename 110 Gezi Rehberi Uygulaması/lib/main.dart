        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  FadeAnimation(1, Text("Hoşgeldiniz!", style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 30
                  ),)),
                  SizedBox(height: 20,),
                  FadeAnimation(1.2, Text("Dünya'yı keşfetmeye ve yeni insanlarla tanışmaya başlayın!",
